...
const RegisterSchedulingTeam = () => {
    ...
    const generateRandomID = () => {
        ...
        const resultID = 'JA' + randomID;
        return resultID;
    };

    const handleRegisterScheduling = async (e: any) => {
        e.preventDefault();
        try {
        ...
        const response = await fetch('http://localhost:3000/api/users/registerScheduling', {
            method: 'POST',
            headers: {
        ...
        <section id='registerRolePage'>
            <div className="registerRoleContainer">
                <div className="registerRoleContent">
                    <form onSubmit={handleRegisterScheduling}>
                        <h2>Scheduling Team Register</h2>
...
export default RegisterSchedulingTeam