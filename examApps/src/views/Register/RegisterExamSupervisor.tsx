...
const RegisterExamSupervisor = () => {
    ...
    const generateRandomID = () => {
        ...
        const resultID = 'PG' + randomID;
        return resultID;
    };

    const handleRegisterSupervisor = async (e: any) => {
        e.preventDefault();
        try {
        ...
        const response = await fetch('http://localhost:3000/api/users/registerSupervisor', {
            method: 'POST',
            headers: {
            ...
            <div className="registerRoleContainer">
                <div className="registerRoleContent">
                    <form onSubmit={handleRegisterSupervisor}>
                        <h2>Exam Supervisor Register</h2>
...
export default RegisterExamSupervisor